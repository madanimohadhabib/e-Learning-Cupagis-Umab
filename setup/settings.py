...
SECRET_KEY = 'django-insecure-#^dnd8)wdg)j1n=6ayo7xxm8b($i!z*lsj8p#(*7a_jz(%+#ui'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles_build', 'static') # Répertoire pour les fichiers statiques collectés en production
